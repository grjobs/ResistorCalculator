...
namespace ElectronicColorCodeCalculator.Tests
{
    ...
    /// <summary>
    ///This is a test class for WebApiConfigTest and is intended
    ///to contain all WebApiConfigTest Unit Tests
    ///</summary>
    [TestClass()]
    public class WebApiConfigTest
    {
        ...
        {
            HttpConfiguration config = null; // TODO: Initialize to an appropriate value
